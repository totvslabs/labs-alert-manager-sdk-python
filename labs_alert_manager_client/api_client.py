...
import labs_alert_manager_client.models
from labs_alert_manager_client import rest
from labs_alert_manager_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(labs_alert_manager_client.models, klass)
